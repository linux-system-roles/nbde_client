...
Linux System Roles CI runs [tmt](https://tmt.readthedocs.io/en/stable/index.html) test plans in [Testing farm](https://docs.testing-farm.io/Testing%20Farm/0.1/index.html) with the [tmt.yml](https://github.com/linux-system-roles/nbde_client/blob/main/.github/workflows/tmt.yml) GitHub workflow.
...
The [tmt.yml](https://github.com/linux-system-roles/nbde_client/blob/main/.github/workflows/tmt.yml) workflow runs the above plan and uploads the results to our Fedora storage for public access.
